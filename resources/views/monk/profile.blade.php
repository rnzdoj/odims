            ...
            <div class="card-body">
                <div class="row">
                    <div class="col">
                        ...
                        <div class="card">
                            <div class="card-header py-3">
                                <p class="text-danger m-0 font-weight-bold">Father</p>
                            </div>
                            <div class="card-body">
                                <form action="{{ route('father.update',  $monk->father->id) }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        <button class="btn btn-danger btn-sm" type="submit">Save&nbsp;Settings</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                    ...
                    <div class="col">
                        ...
                        <div class="card">
                            <div class="card-header py-3">
                                <p class="text-danger m-0 font-weight-bold">Mother</p>
                            </div>
                            <div class="card-body">
