...
Route::prefix('manager')->name('manager.')->group(function () {
    ...
    Route::view('monks', 'manager.monk.index')->name('monks');
    // Route::view('stipend', 'manager.stipend.index')->name('stipend');
    Route::view('rabdey', 'manager.rabdey.index')->name('rabdey');
    Route::get('dratshang/{id}', function($id){
        return view('manager.dratshang.index')->with('id', $id);
    })->name('dratshang.index');
    // Route::view('dratshang', 'manager.dratshang.index')->name('dratshang.index');
});
